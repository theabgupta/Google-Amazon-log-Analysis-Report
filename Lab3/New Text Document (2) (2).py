...
def tf(tokens):
    ...
    dict={}
    for t in tokens:
        dict[t]=dict.get(t,0)+(1.0/len(tokens))
    return dict
...
similarityAmazonGoogle = 0.000303171940451#similar('b000o24l3q', 'http://www.google.com/base/feeds/snippets/17242822440574356561')
...
similarityAmazonGoogleBroadcast = 0.000303171940451#similarBroadcast('b000o24l3q', 'http://www.google.com/base/feeds/snippets/17242822440574356561')
